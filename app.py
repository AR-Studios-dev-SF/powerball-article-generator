...
def powerball_article():
    ...
    if "None" in jackpot_winners:
        ...
        body = f"There was no Powerball winner in the last drawing, which took place on {date}."
    else:
        winner_state = jackpot_winners
        headline = f"There was a Powerball Winner from the state of {winner_state} in the Last Drawing"
        body = f"The winning Powerball numbers for the last drawing, which took place on {date}, were {winning_numbers}. The winning ticket was sold in {winner_state}."
    ...
    body += f" The next Powerball drawing will take place on {next_drawing_date}, with a potential prize of {jackpot_amount}."
